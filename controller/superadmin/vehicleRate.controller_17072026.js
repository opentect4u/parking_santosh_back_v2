...
const save_add_vehicle_rate = async (req, res) => {
  try {
    ...
    if (error) {
      ...
      return res.redirect(isUpdate ? `/superadmin/vehicle_edit_rate?id=${req.body.id}&customer_id=${req.body.cust_id}` : "/superadmin/vehicle_rate");
    }
    ...
    if (isUpdate) {
      res.redirect(`/superadmin/vehicle_edit_rate?id=${req.body.id}&customer_id=${req.body.cust_id}`);
    } else {
      res.redirect("/superadmin/vehicle_rate");
    }
  }
