...
const { vehicle_in, insert_receipt, insert_vehicle_outpass, update_car_in_flag, insert_advance_receipt_update, outpass_advance_receipt_update } = require("../../../module/V3/car_in_out_receipt");
    ...
    try {
        ...
        if ((md_setting.msg).length != 0) {
            ...
            if (md_setting_data.dev_mod == 'D' || md_setting_data.dev_mod == 'R') {
                let td_vehicle_in = await vehicle_in(userData, value.vehicle_id, value.vehicle_no,value.date_time,md_setting_data.dev_mod, md_setting_data.parking_entry_type)
