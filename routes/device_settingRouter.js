...
const { device, show_device, edit_device, save_edit_device, save_add_device, device_id } = require('../controller/customer/Device.controller');
const { AuthCheckedMW } = require('../middleware/AuthChecked.middleware');
 ...
 DeviceRouter.get('/device_id',AuthCheckedMW,device_id);
