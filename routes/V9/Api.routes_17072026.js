...
const { register, login, test, change_password, check_report_password, logout } = require('../../controller/api/V9/Auth.controller');
...
const { general_settings, receipt_setting, rate_dtls_list, gst_list, fixed_rate_dtls_list, my_shift } = require('../../controller/api/V9/Master.controller');
const { car_in, search_car, out_pass, car_in_fixed, car_advance_amount, car_in_out, search_car_scan } = require('../../controller/api/V9/CarInCarOut.controller');
const { vehicle_wise, detail_report, shift_wise, operator_wise, unbilled, dashboard, shift_wise_report } = require('../../controller/api/V9/ReportApi.controller');
