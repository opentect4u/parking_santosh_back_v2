...
const vehicle_in = (userData, vehicle_id, vehicle_no, date_time, dev_mod, receipt_type) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let vehicle_in_values = `(${userData.id}, ${vehicle_id}, ${userData.customer_id}, '${userData.device_id}', '${vehicle_no}', '${dateFormat(date_time, "yyyy-mm-dd HH:MM:ss")}', '${dev_mod}', '${receipt_type}', ${receipt_number}, '${datetime}')`;
...
//             let receipt_number = new Date().getTime();
//             let vehicle_in_fields = `(user_id_in, vehicle_id, customer_id, device_id, vehicle_no, date_time_in, oprn_mode, receipt_type, receipt_no, created_at)`;
//             let vehicle_in_values = `(${userData.id}, ${vehicle_id}, ${userData.customer_id}, '${userData.device_id}', '${vehicle_no}', '${date_time}', '${dev_mod}', '${receipt_type}', ${receipt_number}, '${datetime}')`;
