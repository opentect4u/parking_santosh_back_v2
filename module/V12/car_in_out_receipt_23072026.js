...
const vehicle_subscription_in = (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const paid_amt =
        parseFloat(base_amt) + parseFloat(cgst) + parseFloat(sgst);
      ...
      let vehicle_in_values = `(${userData.id}, ${vehicle_id}, ${userData.customer_id}, '${userData.device_id}', '${vehicle_no}','${mst_id}', '${start_date}','${end_date}','${no_of_days}','${base_amt}','${cgst}','${sgst}','${igst}','${paid_amt}','${paymode}', '${serial_no}',
